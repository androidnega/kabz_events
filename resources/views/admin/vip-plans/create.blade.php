    ...
    <div class="p-4 sm:p-6 lg:p-8">
        <x-card class="p-6">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-sm text-gray-600 mt-1">Add a new VIP subscription plan for vendors</p>
                </div>
                ...
                <form action="{{ route('admin.vip-plans.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div class="bg-purple-50 border-l-4 border-purple-500 p-4 rounded">
                        <p class="text-sm text-purple-700">
                            <strong>💡 Tips for creating VIP plans:</strong><br>
                            • Set competitive pricing based on features<br>
                            • Higher priority levels appear first in search results<br>
                            • Free ads help vendors promote their services<br>
                            • Consider offering discounts for longer durations
                        </p>
                    </div>

                    <div class="flex items-center space-x-4 pt-4">
                        <button type="submit" class="px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition">
                            <i class="fas fa-save mr-2"></i> Create VIP Plan
                        </button>
